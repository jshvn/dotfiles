...
**Plans**: 6 plans
  ...
  - [x] 13-03-PLAN.md — Dead-code removal: Class A preserved, Class B strict per D-08; orphan fixtures per D-10; grep-verified zero hits (REVW-03, REVW-06)
  - [x] 13-04-PLAN.md — Duplication consolidation: rule-of-three per D-09; new helpers in taskfiles/helpers.yml or install/messages.zsh (REVW-04, REVW-06)
  - [x] 13-05-PLAN.md — links:* readlink -f target-match fix (helper path preferred via pre-flight); 13-SMOKE.md manual procedure per D-07 (REVW-05, REVW-06)
  - [x] 13-06-PLAN.md — MEDIUM/LOW triage: fix-now annotated with SHA; defer per D-11(a) Phase 14 TRIM-NN or D-11(b) needs-new-infra + ROADMAP backlog (REVW-02, REVW-06)
...
| 14. Comment + Doc Trim | 1/3 | In Progress|  |
